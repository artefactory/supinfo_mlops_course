...
from config import PATH_TRAIN_DATA, PATH_TEST_DATA, logger, MLFLOW_TRACKING_URI, MLFLOW_EXPERIMENT_NAME, REGISTERED_MODEL_NAME
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        params = {"model_type": pipeline.steps[1][1].__class__.__name__,
